...
function ProductModal({ modalMode, tempProduct, isOpen, setIsOpen,getProduces }) {

    //只做初始值，之後再change時不會有做用到。
    ...
    const handleFileChange = async (e) => {
        ...
        try {
            ...
            setModalData({ ...modalData, imageUrl: uploadImageUrl });
        } catch (error) {
            ...
            <div className="modal-dialog modal-dialog-centered modal-xl">
                <div className="modal-content border-0 shadow">
                    ...
                    <div className="modal-footer border-top bg-light">
                        <button type="button" value={modalData.is_enabled} className="btn btn-secondary" onClick={handleCloseProductModal}>
                            取消
                        </button>
